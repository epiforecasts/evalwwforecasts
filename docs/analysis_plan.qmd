...
We will use the following models to produce forecasts of the 7-day rolling sum of COVID-19 hopsital admissions for 28 days ahead of the forecast date:
...
Figure 1. Schematic diagram describing the retrospective production of forecasts and the evaluation procedure
...
Figure 2. Visual comparison of fit and forecast for a subset of locations and forecast dates (can pick ones where ww improves, wastewater has no impact, wastewater degrades performance) + fit to wastewater data
...
Figure 3. Visual comparison of forecast performance across forecast dates for a subset of locations for horizons 1-7
...
1.  Fig 2 & 3 with baseline ARIMA
2.  Fig 3 for additional horizons (7-14, 14-21, 21-28)

## Quantitative forecast comparison

Figure 4. "traditional" score comparison: overall, by horizon, by location, by forecast date, by location and forecast date
